...
// Creating an instance using the .call() method
let i3 = {};
iPhone3.call(i3, 1, "B09X67JBQV", 7.8, "12MP", "Bluetooth 5.1");
// iPhone3.apply(i3, [1, "B09X67JBQV", 7.8, "12MP", "Bluetooth 5.1"]);

// Accessing properties
console.log(i3.ASIN); // Output: 1
console.log(i3.color); // Output: "B09X67JBQV"
console.log(i3.display); // Output: 7.8
console.log(i3.camera); // Output: "12MP"
